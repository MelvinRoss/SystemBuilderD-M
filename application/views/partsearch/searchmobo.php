 ...
 * 
 */
echo "<div align='right'>".anchor('welcome/motherboard', 'Change Search Options')."</div>";
echo "<div id='searchmobo'>";
$searchresult=10; //add the number of results here
$arrayresults=array();

$tableheader=array('','Model','Socket', 'Sata Ports','Max RAM','PCIE Slots','Price','Add to Build');
$data['Manufacturer']="EVGA";
$data['Socket']="939";
$data['SATA']="5";
$data['RAM']="32GB";
$data['PCIE']="4";
